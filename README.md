...
- Halaman tamu memandu tamu mengisi nama lebih dulu, mendukung kamera bawaan HP, galeri, kamera live depan/belakang, slider zoom kamera, dan preview live yang lebih ringkas di HP.
...
Saat ini semua berjalan sebagai prototipe statis di browser. Untuk sinkronisasi lintas device, isi `app-config.js` dengan Supabase project URL, anon key, dan event slug, lalu ikuti `SUPABASE_SETUP.md`.
